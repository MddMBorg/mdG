...
Convert the [MemberKind](/Vsxmd-Units/Vsxmd-Units-MemberKind.md/#T-Vsxmd-Units-MemberKind) to its lowercase name.
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| memberKind | [Vsxmd.Units.MemberKind](/Vsxmd-Units/Vsxmd-Units-MemberKind.md/#T-Vsxmd-Units-MemberKind) | The member kind. |
