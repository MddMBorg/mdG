...
Initializes a new instance of the [MemberName](/Vsxmd-Units/Vsxmd-Units-MemberName.md/#T-Vsxmd-Units-MemberName) class.
...
For [Type](/Vsxmd-Units/Vsxmd-Units-MemberKind.md/#F-Vsxmd-Units-MemberKind-Type), show as `## Vsxmd.Units.MemberName [#](#here) [^](#contents)`.
